...
const CheckboxQuestion: React.FC<ICheckboxQuestion> = ({ defaultAnswers, checkBoxChangeParent, checkBoxChangeChild, flexDirection, onFocus, onBlur }) => {
  ...
  return (
    <>
      ...
      <div
        className={flexDirection === 'column' ? `${classes.fcol}` : undefined}
        onKeyPress={() => {}}
        role="button"
        tabIndex={0}
        onFocus={() => {
