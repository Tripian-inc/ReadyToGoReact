...
const OpeningsSelection: React.FC<IOpeningsSelection> = ({ openingTimes, clicked, bookingHour }) => {
    ...
    return (
      <div className="row">
        ...
        <div className="col col12 center my2">
          <Button color="danger" size="small" text="Load More" onClick={() => setLimit(limit + 6)} />
        </div>
      </div>
    );
  }
